...
public class CacheUtil {
	...
	public static Properties readConfigurableService() 
	{
		...
		try	{
			...
			ConfigurableService udcs = bp.getConfigurableService(CACHE_CONFIG_TYPE, CACHE_CONFIG_SERVICE);
	...
	public static String getDataFromXC10Cache(String key, String cacheMap, String xc10ConnConfig) 
	{
		...
		try	{
			...
			URL = props.getProperty("ServerUrl").endsWith("/") ? props.getProperty("ServerUrl") : props.getProperty("ServerUrl").concat("/");			
	...
	public static String getExternalErrorCodeFromXC10(String key, String errorCode, String cacheMap, String xc10ConnConfig) {
		...
		{
			Properties props = readConfigurableService();
			String URL = props.getProperty("ServerUrl").endsWith("/") ? props.getProperty("ServerUrl") : props.getProperty("ServerUrl").concat("/");
			URL = URL.concat(cacheMap).concat("/").concat(encodeValue(key.replace("#", "_")));
	...
	public static String getExternalCodeFromXC10(String key, String swCode, String cacheMap, String xc10ConnConfig) {
		...
		//Object extCode = "";
		String extCode = "";
		String cacheKey = "NCLIIB_"+key.replace("#", "_").concat("_SW_" + swCode);

		try
		{
			Properties props = readConfigurableService();
			String URL = props.getProperty("ServerUrl").endsWith("/") ? props.getProperty("ServerUrl") : props.getProperty("ServerUrl").concat("/");
			URL = URL.concat(cacheMap).concat("/").concat(encodeValue(cacheKey));
			
			//String cacheVal = (String) HTTPGetCall(URL, props);
			 extCode = (String) HTTPGetCall(URL, props);
			/*if (cacheVal != null) {
	...
	public static String getSWCodeFromXC10(String key, String extCode, String cacheMap, String xc10ConnConfig) {
		...
		String swCode = "";
		String cacheKey = "NCLIIB_"+key.replace("#", "_").concat("_EXT_" + extCode);
		...
		try
		{
			...
			URL = URL.concat(cacheMap).concat("/").concat(encodeValue(cacheKey));
			 ...
			 swCode = (String) HTTPGetCall(URL, props);
	...
	public static String getSubExternalCodeFromXC10(String key, String swCode, String cacheMap, String xc10ConnConfig) {
		...
		String extCode = "";
		String cacheKey = "NCLIIB_" + key.replace("#", "_").concat("_SUB_SW_"+swCode);
...
//			}
	...
	public static String getSubSWCodeFromXC10(String key, String extCode, String cacheMap, String xc10ConnConfig) {
		...
		String swCode = "";
		String cacheKey = "NCLIIB_"+key.replace("#", "_").concat("_SUB_EXT_"+extCode);
...
//			}
	...
	public static Object HTTPGetCall(String cacheUrl, Properties props) throws ParseException {
		...
		RequestConfig connConfig = RequestConfig.custom()
				  					...
				  					.setSocketTimeout(Integer.parseInt(connTimeout))
				  					.build();
		...
		try {
		    ...
		    if (httpResp.getStatusLine().getStatusCode() == 200) {
				...
				throw new Exception(Integer.toString(httpResp.getStatusLine().getStatusCode()) + " " + httpResp.getStatusLine().getReasonPhrase());
		    }
		} catch (Exception e) {
			value = ("ERROR: " + e.getMessage());
		} finally {			
	...
	public static String HTTPPostCall(String cacheUrl, HashMap <String,String> dataMap, Properties props) throws ParseException {
		String basicAuth = props.getProperty("BasicAuth");
		String connTimeout = props.getProperty("ConnectionTimeout");
	...
	@SuppressWarnings("unchecked")
	public static String NativeHTTPPostCall(String cacheUrl, String basicAuth, String value, String connTimeout) throws IOException {
